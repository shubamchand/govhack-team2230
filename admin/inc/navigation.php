              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-2">
                   <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=vehicles" class="nav-link nav-event">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=vehicle_types" class="nav-link nav-event">
                        <i class="nav-icon fas fa-th-list"></i>
                        <p>
                          Vehicle Types
                        </p>
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=user/list" class="nav-link nav-list">
