	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<input type="password" class="form-control form-control-sm" name="password" id="password" value="<?php echo isset($password) ? $password : '' ?>" required>
			</div>
		</div>
		<div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <select name="type" id="type" class="custom-select custom-select-sm">
                    <option value="2" <?php echo (isset($type) && $type == 1) ? "selected" : '' ?>>Employee</option>
